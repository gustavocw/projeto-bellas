          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
              ...
              <FormControl>
                ...
                <Button bg={'pink.500'} color={'#fff'} size={'sm'} mx={'2'} my={'2'} >HOMENS</Button>
                <Button bg={'pink.500'} color={'#fff'} size={'sm'} mx={'2'} my={'2'} >MULHERES</Button>
                <Button bg={'pink.500'} color={'#fff'} size={'sm'} mx={'2'} my={'2'} >TRANS</Button>
                <Button bg={'pink.500'} color={'#fff'} size={'sm'} mx={'2'} my={'2'} >CASAIS</Button>
              </FormControl>
            </ModalBody>
